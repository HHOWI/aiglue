# Changelog — `@hhowi/aiglue-client-vue`

Format follows [Keep a Changelog](https://keepachangelog.com/en/1.1.0/); versioned independently from `@hhowi/aiglue-core` and `@hhowi/aiglue-client` per [SemVer](https://semver.org/spec/v2.0.0.html).

## [0.1.0] — 2026-04-28

Initial release. Vue 3 composable mirror of `@hhowi/aiglue-client@0.1.0` — see that package's CHANGELOG for the shared behavior contract.
...
- Re-exports the `AIEResponse` discriminated union from `@hhowi/aiglue-core`.
